...
import com.liferay.site.cms.site.initializer.internal.display.context.TagsSectionDisplayContext;
...
public class TagsSectionFragmentRenderer extends BaseSectionFragmentRenderer {
	...
	public void render(
		...
		try {
			RequestDispatcher requestDispatcher =
				_servletContext.getRequestDispatcher("/tags_section.jsp");

			httpServletRequest.setAttribute(
				TagsSectionDisplayContext.class.getName(),
				new TagsSectionDisplayContext(
