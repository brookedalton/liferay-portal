...
public abstract class BaseExpandoTestCase extends BaseIndexingTestCase {
	...
	protected ExpandoQueryContributorHelperImpl
		createExpandoQueryContributorHelper() {

		return new ExpandoQueryContributorHelperImpl() {
			{
				expandoBridgeFactory = createExpandoBridgeFactory();
				expandoBridgeIndexer = createExpandoBridgeIndexer();
				expandoColumnLocalService = createExpandoColumnLocalService();
			}
		};
	}
